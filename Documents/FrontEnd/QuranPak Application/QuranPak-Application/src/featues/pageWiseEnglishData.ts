...
export const engQuranApi = createApi({
   // define the reducerPath here
  reducerPath: 'engQuranApi',
  ...
  endpoints: (builder) => ({
    ...
    getEngDataByPage: builder.query<PageWiseInterface, string>({
      query: (pageNumber) => `page/${pageNumber}/en.asad`,
...
export const { useGetEngDataByPageQuery } = engQuranApi;
