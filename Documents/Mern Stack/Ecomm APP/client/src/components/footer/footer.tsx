...
const Footer = () => {
    return (
        <>
            <footer className="px-3 pt-4 lg:px-9 border-t-2 bg-gray-50 mt-20 ">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4 py-10">

                    <div className="sm:col-span-2">
                        <a href="#" className="inline-flex items-center">

                            <span className="ml-2 text-xl font-bold tracking-wide text-gray-800"> <img className="h-10 w-auto" src="https://www.boat-lifestyle.com/cdn/shop/files/boAt_logo_small_3067da8c-a83b-46dd-b28b-6ef1e16ccd17_small.svg?v=1693549434" alt="Your Company" /></span>
                        </a>
